...
XULManager.prototype.insertXUL = function(id, iconURL, xul) {
    let icon = this.doc.createElement("toolbarbutton");
    icon.setAttribute("xmlns", "http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul");
    icon.setAttribute("id", id);
    icon.setAttribute("type", "panel");
